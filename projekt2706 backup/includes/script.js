...
// Annahme: data enthält das Array mit Pokémon-Daten
const data = [{
  "Name": "Bisasam",
  "Typ": "Pflanze/Gift",
...
},
{
  ...
  "Größe": "0.7 m"
}]; // Deine Pokémon-Daten hier einfügen
...
app.get('/pokemon', (req, res) => {
  const id = req.query.id; // Die ID des ausgewählten Pokémons wird aus der URL abgerufen
  const selectedPokemon = data.find(pokemon => pokemon.id === id);

  res.render('pokemon', { selectedPokemon });
});
